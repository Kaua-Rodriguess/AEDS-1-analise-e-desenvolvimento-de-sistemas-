...
int main(){
    ...
    //ETAPA 1
    int chute,tentativa=0,nivel,pontos=100;
    ...
    switch(nivel){
     ...
     //AQUI EU PEGO O ULTIMO NUMERO QUE EU DIGITEI NA 3º TENTATIVA E COMPARO, SE ELE FOR IGUAL O PROGRAMA FALA QUE EU ACERTEI SE NÃO É POQUE MEU NUMERO DE TENTAIVAS ACABOU
        if(chute == numeroAte10){
            printf("\n PARABENS, voce acertou o numero secreto era %d \n Sua pontuacao FINAL: %d pontos",numeroAte10,ptsFinal);
        }
        else{
     ...
     //AQUI EU PEGO O ULTIMO NUMERO QUE EU DIGITEI NA 3º TENTATIVA E COMPARO, SE ELE FOR IGUAL O PROGRAMA FALA QUE EU ACERTEI SE NÃO É POQUE MEU NUMERO DE TENTAIVAS ACABOU
        if(chute == numeroAte50 ){
            printf("\n PARABENS, voce acertou o numero secreto era %d \n Sua pontuacao FINAL: %d pontos",numeroAte50 pontos-(tentativa*10));
        }
        else{
     ...
     do{
       ...
       //VERIFICO SE MEU NUMERO É MENOR OU MAIOR QUE O NUMERO SECRETO, MEU PROGRAMA ENCERRA QUANDO O NUMERO FOR IGUAL E TENTATIVA FOR=10
